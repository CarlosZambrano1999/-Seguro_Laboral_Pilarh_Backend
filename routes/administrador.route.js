...
router.route('/crearAdministrador').all(checkAuth).all(checkRoleAuth([1])).post(administradorController.crearAdministrador); //http://localhost:8080/Administrador/crearAdministrador
router.route('/editarAdministrador').all(checkAuth).all(checkRoleAuth([1])).post(administradorController.editarAdministrador); //http://localhost:8080/Administrador/editarAdministrador
